export const newCharacters = {
    ...
    guerrero:{name:'', class:'Guerrero', level:1, life:10, maxLife:10, stamina:6, maxStamina:6, attack:2, defence:7, mana:1, maxMana:1, speed:3, 
        exp:0, maxExp:12, knowledge: 0, state:[], skills:[]},//24

    asesina:{name:'', class:'Asesina',   level:1, life:7, maxLife:7, stamina:4, maxStamina:4, attack:7, defence:3, mana:2, maxMana:2, speed:7, 
    exp:0, maxExp:12, knowledge: 0, state:[], skills:[] },//26
    
    mago:{name:'', class:'Mago',         level:1, life:7, maxLife:7, stamina:4, maxStamina:4, attack:1, defence:3, mana:15, maxMana:15, speed:8, 
    exp:0, maxExp:12, knowledge: 0, state:[], skills:['Golpe Chispa']},
