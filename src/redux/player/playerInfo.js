...
export const playerInfo = createSlice({
    ...
    reducers:{
        ...
        //modifiers
            ...
            modMana:(state, action) => { const newValues = state; newValues.mana = newValues.mana + action.payload; return newValues },
...
export const { setPlayer, modStamina, modLife, modMana, modExp, rest, guardUp, guardDown } = playerInfo.actions
